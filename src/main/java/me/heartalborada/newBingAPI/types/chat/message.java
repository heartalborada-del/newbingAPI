...
public class message {
    ...
    public message(String locale, String market, String region, String location, me.heartalborada.newBingAPI.types.chat.locationHints locationHints, String timestamp, String text) {
        this.locale = locale;
        this.market = market;
        this.region = region;
